        ...
        <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
            ...
            <div className="flex items-center gap-2.5">
              {SOCIALS.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-muted-border/30 flex items-center justify-center text-neutral-text/70 hover:text-accent hover:border-accent/80 hover:bg-accent/15 social-icon-glow cursor-pointer transition-colors"
                >
          ...
          <div>
            ...
            <div className="space-y-3 text-xs text-neutral-text/70 mb-6">
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-4 h-4 text-emerald-500 shrink-0 group-hover:scale-110 transition-transform"
                  aria-hidden="true"
                >
            ...
            >
              ...
              <button
                type="submit"
                className="brand-btn-primary w-8 h-8 rounded-lg flex items-center justify-center cursor-pointer shrink-0 hover:scale-105 transition"
              >
